...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
	...
	function o(r) {
		...
		else if ("polyline" === l || "polygon" === l) for (n = r.getAttribute("points").match(h) || [], "polygon" === l && n.push(n[0], n[1]), o = 0, a = 2; a < n.length; a += 2) o += e(n[a - 2], n[a - 1], n[a], n[a + 1], g, u) || 0;
	...
	(n = _gsScope._gsDefine.plugin({
		...
		init: function(e, t, n, s) {
			...
			if (!g) return window.location.href = "http://" + d + l + "?plugin=DrawSVGPlugin&source=codepen", !1;
			var h, u, c, p, C = o(e) + 1;
